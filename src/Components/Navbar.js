...
const Navbar = () => {
  ...
  return (
    <>
      <svg
        ...
        onClick={toggleNavbar} // When clicked, toggle the navbar
  ...
  <a className="socialContainer containerOne" href="https://www.instagram.com/cac.cuchd/">
  ...
  <a className="socialContainer containerTwo" href="https://www.youtube.com/@insightuniverse.official">
  <svg className="socialSvgs twitterSvg" viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">

<g id="SVGRepo_bgCarrier" strokeWidth="0"/>

<g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"/>

<g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M18.168 19.0028C20.4724 19.0867 22.41 17.29 22.5 14.9858V9.01982C22.41 6.71569 20.4724 4.91893 18.168 5.00282H6.832C4.52763 4.91893 2.58998 6.71569 2.5 9.01982V14.9858C2.58998 17.29 4.52763 19.0867 6.832 19.0028H18.168Z" stroke="#f5f0f0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/> <path fillRule="evenodd" clipRule="evenodd" d="M12.008 9.17784L15.169 11.3258C15.3738 11.4454 15.4997 11.6647 15.4997 11.9018C15.4997 12.139 15.3738 12.3583 15.169 12.4778L12.008 14.8278C11.408 15.2348 10.5 14.8878 10.5 14.2518V9.75184C10.5 9.11884 11.409 8.77084 12.008 9.17784Z" stroke="#f5f0f0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/> </g>

</svg></a>
    
  <a className="socialContainer containerThree" href="https://www.linkedin.com/company/cac-connecting-all-circles/posts/?feedView=all">
  ...
  <a className="socialContainer containerFour" href="https://chat.whatsapp.com/H7Om72NA4nwLSIvze6iA7y">
